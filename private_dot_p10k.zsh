# Generated by Powerlevel10k configuration wizard on 2022-03-19 at 13:56 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 58020.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, round heads, round tails, 1 line, sparse, many icons,
# concise, instant_prompt=auto-off.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_BACKGROUND=255
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_GAP_BACKGROUND=255
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=116
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='٩(ˊᗜˋ*)و'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=045
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=047
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=011
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=047
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=011
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=025
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=046
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=046
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=012
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=226
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=209
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=226
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=209
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=226
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=209
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=75
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=156
